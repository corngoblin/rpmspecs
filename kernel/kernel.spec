...
%define arkbuild 0
%if 0%{?fedora}
%define distbuildid %{lua: print(rpm.expand("%{arkbuild}") + (rpm.expand("%{fedora}") - 39 ) * 100)}
%endif
#
...
#
%changelog
* Fri Aug 15 2025 Thorsten Leemhuis <fedora@leemhuis.info> [6.15.10-0.vanilla]
- import ark-infra from kvc-infra-stable-6.15 (4d59f9d41ad) (Thorsten Leemhuis)
- Linux v6.15.10
